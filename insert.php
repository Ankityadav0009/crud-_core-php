...
if(isset($_POST['submitf'])){
   ...
   $sql =" INSERT INTO `user2`(`name`, `email`, `gender`, `birthday`, `weight`, `image`, `password`, `Address`, `City`, `State`, `zip`,`dt`,`checkbox`) VALUES ('$name','$email','$Gender','$birthday','$weight','$filename','$password','$Address','$City','$State','$zip' ,current_timestamp(), '$checkBox')";
    ...
    <div class="container my-5 bg-light w-50 p-2 bg-dark br-3">
        ...
        <form class="row g-3 text-light " method="post" enctype="multipart/form-data" >
            ...
            <div class="mb-3 col-md-3">
                ...
                <input type="date" class="form-control" id="birthday" name="birthday" placeholder="DOB" required
                    min="2000-01-02">
            </div>
            <div class="mb-3 col-md-3">

                <label for="weight" class="row m-2">weight:</label>
                <input type="number" class="form-control" id="weight" required name="weight" placeholder="weight"
                    require min="30" max="200">
            </div>
            ...
            <div class="col-12">
                <button type="submit" name="submitf" class="btn btn-primary">Sign in</button>
